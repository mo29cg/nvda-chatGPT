...
API_KEY_NOT_SET_ERROR = f"Your api key is not set! You need to do the following.\n {HOW_TO_GET_KEY}"
API_KEY_INCORRECT_ERROR = f"Your api key is incorrect, Check it again! You need to do the following.\n {HOW_TO_GET_KEY}"

INSUFFICIENT_QUOTA_ERROR = """You ran out of your free credits, or your credits expired! Now you have to start paying. Below is how you set up your payment method.

1. Go to [here](https://platform.openai.com/account/billing/overview)
2. Press "Set up payment method" button.

The cost should be less than $5 a month for normal usage.  
But I highly reccomend set usage limit from [here](https://platform.openai.com/account/billing/limits)  

Also, if you are doing well financially, consider donating to this add-on's creator.  
