...
from kinghttp.cookies import BaseCookie, Morsel, SimpleCookie
...
class CookieJar(AbstractCookieJar):
    ...
    def __init__(
        ...
        *,
        ...
        self._cookies: DefaultDict[str,
                                   SimpleCookie[str]] = defaultdict(SimpleCookie)
    ...
    def clear(self, predicate: Optional[ClearCookiePredicate] = None) -> None:
        ...
        next_expiration = min(self._expirations.values(),
                              default=self._max_time)
        try:
