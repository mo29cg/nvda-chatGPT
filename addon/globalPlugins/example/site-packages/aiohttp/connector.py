...
from kinghttp.cookies import SimpleCookie
...
class BaseConnector:
    ...
    def __init__(
        ...
        *,
        ...
        self._conns: Dict[ConnectionKey,
                          List[Tuple[ResponseHandler, float]]] = {}
        self._limit = limit
...
class _DNSCacheTable:
    def __init__(self, ttl: Optional[float] = None) -> None:
        self._addrs_rr: Dict[Tuple[str, int],
...
class TCPConnector(BaseConnector):
    ...
    def __init__(
        ...
        *,
        ...
        self._throttle_dns_events: Dict[Tuple[str,
                                              int], EventResultOrError] = {}
        self._family = family
    ...
    async def _create_connection(
        ...
        try:
            ...
            raise UnixClientConnectorError(
                self.path, req.connection_key, exc) from exc
